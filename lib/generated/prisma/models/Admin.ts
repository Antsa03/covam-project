...
export type AdminWhereInput = {
  ...
  nom_utilisateur?: Prisma.StringFilter<"Admin"> | string
...
export type AdminScalarWhereWithAggregatesInput = {
  ...
  nom_utilisateur?: Prisma.StringWithAggregatesFilter<"Admin"> | string
...
export type AdminOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"nom_utilisateur" | "mot_de_passe", ExtArgs["result"]["admin"]>
...
export interface AdminDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `nom_utilisateur`
   * const adminWithNom_utilisateurOnly = await prisma.admin.findMany({ select: { nom_utilisateur: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Admins and only return the `nom_utilisateur`
   * const adminWithNom_utilisateurOnly = await prisma.admin.createManyAndReturn({
   *   select: { nom_utilisateur: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more Admins and only return the `nom_utilisateur`
   * const adminWithNom_utilisateurOnly = await prisma.admin.updateManyAndReturn({
   *   select: { nom_utilisateur: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AdminFieldRefs {
  readonly nom_utilisateur: Prisma.FieldRef<"Admin", 'String'>
